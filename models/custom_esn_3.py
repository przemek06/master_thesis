...
class CustomESN3:
    def __init__(self, n_inputs, n_reservoir, n_outputs, r_min, r_max, alpha, sparsity=0.9, input_scaling=1.0, ridge=1e-6, iterations=200, threshold=0.01, seed=None, device=None):
        ...
        W = generate_isospectral_sparse_matrix(
            lambda size: sample_eigenvalues_ginibre(r_min, r_max, alpha, size),
            n_reservoir,
            sparsity,
