...
8. First series is `darkorange`, second is `steelblue`, reference lines and fitted curves are `black` with `linewidth=1`
...
11. Values that would otherwise go in a title belong in the legend or in `results.txt`
