...
eigenvalues = sample_eigenvalues(R, alpha=7.57, beta=0.40, mu=0.0, kappa=0.0, size=N)
...
fig.suptitle("Eigenvalues before and after masked isospectral sparsification")
plt.tight_layout()
...
fig.suptitle("Heatmap before and after masked isospectral sparsification")
plt.tight_layout()
