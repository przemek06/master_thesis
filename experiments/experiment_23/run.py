...
fig.suptitle("CustomESN4 — Lorenz predictions vs target")
plt.tight_layout()
...
plt.xlabel("Trial")
plt.ylabel("Val NMSE")
plt.title("Hyperparameter optimization — CustomESN4 Lorenz")
plt.legend()
plt.tight_layout()
...
ax.set_aspect("equal")
ax.set_title("Eigenvalues of W — CustomESN4 Lorenz")
ax.set_xlabel("Re")
ax.set_ylabel("Im")
plt.tight_layout()
