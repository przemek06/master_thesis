...
print(f"Best val steps until divergence: {study.best_value}")
...
ax.set_title(f"ESNCustomizable (Stiefel W) — Mackey-Glass refined (warmup={WARMUP}, test steps until divergence={test_steps})")
