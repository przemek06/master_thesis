...
fig.suptitle("CustomESN5 — NARMA-10 predictions vs target")
plt.tight_layout()
...
plt.xlabel("Trial")
plt.ylabel("Val NMSE")
plt.title("Hyperparameter optimization — CustomESN5 NARMA-10")
plt.legend()
plt.tight_layout()
...
ax.set_aspect("equal")
ax.set_title("Eigenvalues of W — CustomESN5 NARMA-10")
ax.set_xlabel("Re")
ax.set_ylabel("Im")
plt.tight_layout()
