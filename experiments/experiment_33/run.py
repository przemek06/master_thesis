...
def objective(trial):
    ...
    eigenvalues = sample_eigenvalues_ginibre(r_min=r_min, r_max=r_max,
...
eigenvalues = sample_eigenvalues_ginibre(r_min=best["r_min"], r_max=best["r_max"],
                                         alpha=best["alpha"], size=N_RESERVOIR)
W = generate_sparse_schur(T_template, Z_template, sparsity_mask, eigenvalues)
